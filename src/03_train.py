...
# ═══════════════════════════════════════════════════════════════════════════════
# 1. LOAD TEXT DATA & LABELS
# ═══════════════════════════════════════════════════════════════════════════════
divider("Loading Data & Labels")
...
use_per_family = False

# ═══════════════════════════════════════════════════════════════════════════════
# 2. LOAD COMPRESSION FEATURES AND SEMANTIC SVD
# ═══════════════════════════════════════════════════════════════════════════════
divider("Loading Compression and Semantic Features")
...
try:
    ...
    log(f"  Loaded Handcrafted Compression arrays... Shape: {X_tv.shape}")
    try:
...
# ═══════════════════════════════════════════════════════════════════════════════
# 4. GLOBAL CALIBRATION VIA THRESHOLD SHIFT
# ═══════════════════════════════════════════════════════════════════════════════
divider("Global Calibration via Optimal Threshold")
...
log(f"  Global calibration: selected optimal threshold {best_t:.3f} (F1={best_f1:.4f})")
...
test_preds = (test_probs_initial >= best_t).astype(int)
